      ...
      <div className="top-bar hidden md:block">
        <div className="container-max flex items-center justify-between px-8 py-2 text-xs">
          <div className="flex items-center gap-6">
            <a href="tel:+94771234567" className="flex items-center gap-1.5 hover:text-amber transition-colors">
              <Phone className="w-3 h-3" /> +94 77 123 4567
            </a>
            <a href="mailto:info@aquareefaquarium.lk" className="flex items-center gap-1.5 hover:text-amber transition-colors">
        ...
        <div className="container-max flex items-center justify-between px-4 md:px-8">
          <Link to="/" className="flex items-center gap-2.5">
            <div className="w-10 h-10 rounded bg-navy flex items-center justify-center">
              <span className="font-display text-secondary-foreground text-xl font-bold">A</span>
            </div>
            <div className="leading-tight">
              <span className="font-display text-xl font-bold text-foreground tracking-wide">AQUA REEF</span>
              <span className="block text-[9px] uppercase tracking-[0.25em] text-muted-foreground font-body">Aquarium Specialists</span>
            </div>
          </Link>
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={`text-[13px] font-semibold uppercase tracking-wider transition-colors font-body ${
                  isActive(link.to) ? "text-amber" : "text-foreground hover:text-amber"
                }`}
              >
                {link.label}
              </Link>
            ...
            >
              <div className="px-6 py-6 flex flex-col gap-3">
                ...
                <div className="pt-3 flex flex-col gap-3">
                  <a href="tel:+94771234567" className="flex items-center gap-2 text-sm text-amber font-medium font-body">

        ...
        <div className='grid lg:grid-cols-5 gap-10'>
          ...
          >
            ...
            <p className='text-secondary-foreground/70 mt-4 text-sm leading-relaxed font-body'>
              Book a free consultation and we'll visit your site to discuss your
              requirements and provide a no-obligation quote.
            </p>
            <div className='space-y-4 mt-8'>
              <a
                href='tel:+94771234567'
                className='flex items-center gap-3 text-sm hover:text-amber transition-colors font-body'
              >

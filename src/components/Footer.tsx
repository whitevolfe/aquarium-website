        ...
        <div>
          <Link to='/' className='flex items-center gap-2.5 mb-4'>
            <div className='w-9 h-9 rounded bg-amber flex items-center justify-center'>
              <span className='font-display text-primary-foreground text-lg font-bold'>
                A
              </span>
            </div>
            <div className='leading-tight'>
              ...
              <span className='block text-[8px] uppercase tracking-[0.25em] text-secondary-foreground/50 font-body'>
                Aquarium Specialists
              </span>
            </div>
          </Link>
          <p className='text-secondary-foreground/60 text-sm leading-relaxed font-body'>
            Sri Lanka's premier luxury marine aquarium design & installation
            company. Over 15 years of expertise crafting living masterpieces.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className='space-y-2 text-sm font-body'>
            <li>
              <Link
                to='/'
                className='text-secondary-foreground/60 hover:text-amber transition-colors'
              >
                Home
              </Link>
            </li>
        ...
        <div>
          ...
          <div className='space-y-3 text-sm font-body'>
            <a
              ...
              className='flex items-center gap-2 text-secondary-foreground/60 hover:text-amber transition-colors'
            >
              <Phone className='w-4 h-4 text-amber' /> +94 70 111 1711
            </a>
            <a

      ...
      <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6'>
        {reviews.map((r, i) => (
          <motion.div
            ...
            className='border bg-navy border-border rounded-sm p-6 hover:border-amber/40 hover:shadow-md transition-all duration-300'
          >
            ...
            <p className='text-muted-foreground text-sm leading-relaxed italic font-body mb-5'>
              "{r.text}"
            </p>

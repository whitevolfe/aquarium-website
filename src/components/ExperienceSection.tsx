      ...
      <div className='grid lg:grid-cols-2 gap-0 items-stretch rounded-sm overflow-hidden'>
        ...
        >
          ...
          <p className='text-secondary-foreground/70 mt-5 leading-relaxed font-body text-sm'>
            Aqua Reef Aquarium has been crafting extraordinary marine
            environments across Sri Lanka for over 15 years. Our expertise spans
            residential, commercial, and hospitality sectors — delivering
            aquariums that are both visually stunning and biologically thriving.
          </p>
          <p className='text-secondary-foreground/70 mt-4 leading-relaxed font-body text-sm'>
            Our team includes marine biologists, aquascaping artists, and
            precision engineers — ensuring every installation is a perfect
            balance of science, art, and craftsmanship.
          </p>
          <div className='grid grid-cols-3 gap-4 mt-8'>
            {[
              ...
              <div
                key={s.label}
                className='text-center border border-secondary-foreground/10 rounded-sm py-3'
              >
                <div className='font-display text-2xl font-bold text-amber'>
                  {s.num}
                </div>
                <div className='text-[10px] uppercase tracking-wider text-secondary-foreground/50 font-body mt-1'>
                  {s.label}
                </div>
              </div>
            ))}
